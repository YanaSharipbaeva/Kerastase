...
var Question8 = React.createClass({
    mixins: [
        LinkedStateMixin
    ],
    ...
    componentWillMount() {
        this.getAnswers('grVPCRMDJM', 'first');
        $('#app').height('100%');
    },
    ...
    render: function() {
        var text = 'Are you currently experiencing hair loss?';
            ...
            <div className="wrapperPhrase">
                ...
                <div className="question-wrapper">
                    ...
                    <div className="wrapper-counter">
                        ...
                        <HorizontalLine />
                        <Link to="/question/8" className="activeRound"></Link>
                        <HorizontalLine />
                ...
                <div className="wrapperNext">
                    ...
                    <Link className="linkArrow" onClick={this.changeHeight} to={this.state.checkedAnswer ? "/question/9" : "/question/8"}>
                    </Link>
                </div>
