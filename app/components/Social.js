    ...
    render: function() {
        return (
            <div className="Wrapper-links col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div className="social-links col-xs-6 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <Link to="/start" className="restart_profile col-xs-6 col-sm-12 col-md-6 col-lg-6 col-xl-6">Restart K profile</Link>
            </div>
        );
    }
});
