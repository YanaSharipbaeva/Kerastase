...
var Question7 = React.createClass({
    mixins: [
        LinkedStateMixin
    ],
    ...
    componentWillMount() {
        this.getAnswers('FwvcCdWxLh', 'first');
    },
    ...
    render: function() {
        var text = 'Would you say your hair has a tendency of becoming quickly oily ?';
            ...
            <div className="wrapperPhrase">
                ...
                <div className="question-wrapper">
                    ...
                    <div className="wrapper-counter">
                        ...
                        <HorizontalLine />
                        <Link to="/question/7" className="activeRound"></Link>
                        <HorizontalLine />
